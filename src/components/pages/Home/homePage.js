    ...
    return (
        ...
        <div id="homeWrap" className="container-fluid">
          <div className="jumbotron">
            ...
            <p>
            "Welcome to the money management crud application. Navigate to the expense page to track your expenses, and cash flow page to track you ordinary purchases."
            </p>
          </div>
